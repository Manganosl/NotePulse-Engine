...
class DiscordClient
{
	...
	public static var dUser:String = null;
	...
	private static function onReady(request:cpp.RawConstPointer<DiscordUser>):Void {
		...
		dUser = cast(requestPtr.username, String);
		changePresence();
	}
	...
	private static function onDisconnected(errorCode:Int, message:cpp.ConstCharStar):Void {
		Log.warn('Disconnected ($errorCode: ${cast(message, String)})');
		dUser = null;
	}
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = "Version: " + states.MainMenuState.npeVersion;
	...
	public static function loadModRPC()
	{
		...
		// This out since this engine is intended for source mods
	}
	#end
