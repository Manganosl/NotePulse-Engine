...
class WindowUtil {
	...
	public static function get_monitorResolutionWidth():Float 
		return openfl.system.Capabilities.screenResolutionX;
	
	public static function get_monitorResolutionHeight():Float 
		return openfl.system.Capabilities.screenResolutionY;
	
	public static function get_defaultAppTitle():String 
	...
	public static function setGameDimensions(width:Int, height:Int, cameras:Array<FlxCamera>){
    	...
    	var s = new FunkinRatioScaleMode();
    	s.width = newWidth;
    	s.height = newHeight;
    	FlxG.scaleMode = s;
	}
