...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Keybinds',
			'If unchecked, your keybinds won\'t show up when starting a song.',
			'keybindShowcase',
			'bool');
		addOption(option);
		...
		var option:Option = new Option('Epic! Hit Window',
			'Changes the amount of time you have for hitting a "Epic!" in milliseconds.',
			'epicWindow',
			'int');
		option.displayFormat = '%vms';
		...
		var option:Option = new Option('Sustains as One Note',
			"If checked, Hold Notes can't be pressed if you miss, and count as a single Hit/Miss. Uncheck this if you prefer the old Input System.",
			'guitarHeroSustains',
			'bool');
		addOption(option);
