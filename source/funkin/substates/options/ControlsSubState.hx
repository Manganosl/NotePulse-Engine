...
import funkin.objects.ControlsAlph;
...
class ControlsSubState extends MusicBeatSubstate {
	...
	public function new()
	{
		...
		descText = new FlxText(0, 50, 1180, "Press Q/E to change the Extra Keys Page. Hold SHIFT to scroll 3x faster.", 15);
	...
	function swapMode()
	{
		...
		if (onKeyboardMode) descText.text = 'Press Q/E to change the Extra Keys Page. Hold SHIFT to scroll 3x faster.';
		else descText.text = 'No controller input is supported during gameplay.';
	}
