...
import funkin.substates.options.ModSettingsSubState;
...
class ModsMenuState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		if(controls.BACK && hoveringOnMods)
		{
			...
			else MusicBeatState.switchState(new funkin.states.MainMenuState());
	...
	function reload()
	{
		...
		var curMod:ModItem = modsGroup.members[curSelectedMod];
		MusicBeatState.switchState(new funkin.states.menus.ModsMenuState(curMod != null ? curMod.folder : null));
	}
