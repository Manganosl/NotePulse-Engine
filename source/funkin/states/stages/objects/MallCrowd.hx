...
class MallCrowd extends BGSprite
{
	...
	public function new(x:Float = 0, y:Float = 0, sprite:String = 'base_game/christmas/bottomBop', idle:String = 'Bottom Level Boppers Idle', hey:String = 'Bottom Level Boppers HEY')
	{
