...
class ABotSpeaker extends FlxSpriteGroup
{
	...
	public function new(x:Float = 0, y:Float = 0)
	{
		...
		bg = new FlxSprite(90, 20).loadGraphic(Paths.image('base_game/abot/stereoBG'));
		bg.antialiasing = antialias;
		add(bg);

		var vizX:Float = 0;
		var vizY:Float = 0;
		var vizFrames = Paths.getSparrowAtlas('base_game/abot/aBotViz');
		...
		eyes.anim.frameIndex = eyes.anim.numFrames - 1;
		add(eyes);
