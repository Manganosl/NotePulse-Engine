...
class Macro {
	public static function includeFiles() {
		Compiler.include('funkin.game.modchart', true, ['funkin.game.modchart.backend.standalone.adapters']);
		Compiler.include("funkin.game.modchart.backend.standalone.adapters." + haxe.macro.Context.definedValue("FM_ENGINE").toLowerCase());
	}
