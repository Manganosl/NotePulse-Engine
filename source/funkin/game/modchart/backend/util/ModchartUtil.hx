...
import funkin.game.modchart.engine.events.Event;
import funkin.game.modchart.engine.events.types.AddEvent;
import funkin.game.modchart.engine.events.types.EaseEvent;
...
@:keep class ModchartUtil {
	...
	@:pure
	inline public static function resolveCameras(playfield:funkin.game.modchart.engine.ModPlayField, item:FlxSprite):Array<FlxCamera> {
		@:privateAccess
