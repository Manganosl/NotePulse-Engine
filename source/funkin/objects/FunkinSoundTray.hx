...
class FunkinSoundTray extends FlxSoundTray
{
	...
	public function new()
	{
		...
		var bg:Bitmap = new Bitmap(FlxAssets.getBitmapData(Paths.getPath('images/soundtray/volumebox.png', IMAGE)));
		...
		var backingBar:Bitmap = new Bitmap(FlxAssets.getBitmapData(Paths.getPath('images/soundtray/bars_10.png', IMAGE)));
		backingBar.x = 9;
		backingBar.y = 5;
		...
		for (i in 1...11)
		{
			var bar:Bitmap = new Bitmap(FlxAssets.getBitmapData(Paths.getPath('images/soundtray/bars_$i.png', IMAGE)));
			bar.x = 9;
			bar.y = 5;
